                        ...
                        <nav class="uk-navbar uk-navbar-container uk-navbar-transparent" data-uk-navbar>
                            <div class="uk-navbar-top">
                                <div class="uk-navbar-left">
                                    <a class='uk-logo uk-navbar-item uk-h4 uk-h3@m uk-margin-remove' href='<?php echo $redirect_url; ?>'> <img class="uk-visible dark:uk-hidden" width="150px" src="/assets/images/logo-light.svg" alt="Logo" style="width: 150px;" loading="lazy"> <img class="uk-hidden dark:uk-visible" width="120" style="width: 150px;" src="/assets/images/logo-dark.svg" alt="Logo" loading="lazy"> </a>
                                </div>
            ...
            <div class="uk-grid uk-grid-large@m uk-grid-match uk-child-width-1-4@m uk-child-width-1-2 uk-margin-medium-top uk-margin-large-top@m" data-uk-grid="">
                                                   ...
                                                   foreach($services as $service){
                                                    ...
                                                    <div style="cursor: pointer;" onclick="window.location.replace('<?php echo $redirect_url; ?>')">
                                                        <div class="uk-panel" style="border:2px solid #2600fc;border-image: linear-gradient(25deg, #2600fc, #ff00ea) 1;border-radius:56px;padding:10px;">
                        ...
                        <div class="uk-width-large@m">
                            <div class="uk-panel">
                                ...
                                <ul class="uk-subnav uk-subnav-small uk-flex-center uk-text-gray-40 uk-margin-top uk-margin-medium-top@m">
                                    <li>
                                        <a href="<?php echo $redirect_url; ?>"><span class="uk-icon uk-icon-medium@m unicon-logo-twitter"></span></a>
                                    </li>
                                    <li>
                                        <a href="<?php echo $redirect_url; ?>"><span class="uk-icon uk-icon-medium@m unicon-logo-discord"></span></a>
                                    </li>
                                    <li>
                                        <a href="<?php echo $redirect_url; ?>"><span class="uk-icon uk-icon-medium@m unicon-logo-instagram"></span></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
